...
function ResultList({ results, term }: Props) {
  return (
    <div className='flex md:px-5'>
              ...
              <div
                ...
                <div className='flex flex-col'>
                  {filter.values.map((value) => (
                    <Link
                      href={`http://www.google.com/${value.url}`}
                      prefetch={false}>
                      {value.value}
                    </Link>
                  ))}
      ...
      <div className='px-5 md:p-10 md:pt-0 space-y-5'>
          ...
          <div key={pageResult.job_id} className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3'>
            ...
            <div className='md:col-span-2 lg:col-span-3 xl:col-span-4 py-5'>
              <div className='flex space-x-2 items-center divide-x-2'>
                ...
                <h2 className='text-xl font-semibold pl-2'>Serach Results for Page {i + 1}</h2>
              </div>
